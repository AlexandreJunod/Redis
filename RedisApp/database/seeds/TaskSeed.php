...
class TaskSeed extends Seeder
{
    ...
    public function run()
    {
        ...
        Redis::rpush("tasks:todos.id=1", 1, 2, 3, 4, 5, 6); // Redis list: https://redis.io/topics/data-types-intro#redis-lists
        Redis::rpush("tasks:todos.id=2", 7, 8, 9, 10); // Redis list: https://redis.io/topics/data-types-intro#redis-lists
